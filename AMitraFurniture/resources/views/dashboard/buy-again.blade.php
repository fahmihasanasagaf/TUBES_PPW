...
<head>
    ...
    <title>Beli Lagi - A Mitra Furniture</title>
...
<body>
    ...
    <div id="buy-again-screen" @class(['screen', 'active'])>
        <div @class(['container', 'py-4'])>
            <h2 @class(['mb-4'])>Beli Lagi</h2>
            
            <div @class(['row']) id="buy-again-products">
                <!-- Buy again products will be loaded here by JavaScript -->
            </div>
        </div>
    </div>

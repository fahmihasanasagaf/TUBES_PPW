...
<head>
    ...
    <title>Favorit - A Mitra Furniture</title>
...
<body>
    ...
    <div id="favorites-screen" @class(['screen', 'active'])>
        <div @class(['container', 'py-4'])>
            <h2 @class(['mb-4'])>Favorit Saya</h2>
            
            <div @class(['row']) id="favorites-products">
                <!-- Favorite products will be loaded here by JavaScript -->
            </div>
        </div>
    </div>

...
<head>
    ...
    <title>Riwayat Pesanan - A Mitra Furniture</title>
...
<body>
    ...
    <div id="order-history-screen" class="screen active">
        <div class="container py-4">
            <h2 class="mb-4">Riwayat Pesanan</h2>
            
            <ul class="nav nav-tabs mb-4" id="orderTabs">
                <li class="nav-item">
                    <button class="nav-link active" onclick="switchOrderTab('all')">Semua</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" onclick="switchOrderTab('unpaid')">Belum Bayar</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" onclick="switchOrderTab('packed')">Dikemas</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" onclick="switchOrderTab('shipped')">Dikirim</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" onclick="switchOrderTab('rated')">Diberi Penilaian</button>
                </li>
            </ul>
